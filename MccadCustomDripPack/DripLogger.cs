...
{
    internal static class DripLogger
    {
        private static readonly ManualLogSource _logger;

        static DripLogger()
        {
            // We create our private logger instance with the plugin name MccadCustomDripPack
            _logger = new ManualLogSource("MccadCustomDripPack");
